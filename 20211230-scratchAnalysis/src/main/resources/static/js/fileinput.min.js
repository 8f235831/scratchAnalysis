...
!function (e) {
    ...
    t = {
        ...
        closeButton: function (e) {
            return e = (t.isBs(5) ? "btn-close" : "close") + (e ? " " + e : ""), '<button type="button" class="' + e + '" aria-label="Close">\n' + (t.isBs(5) ? "" : '  <span aria-hidden="true">&times;</span>\n') + "</button>"
        },
        ...
        whenAll: function (i) {
            var a, r, n, o, s, l, d = [].slice, c = 1 === arguments.length && t.isArray(i) ? i : d.call(arguments),
                u = e.Deferred(), p = 0, f = c.length, m = f;
            for (n = o = s = Array(f), l = function (e, t, i) {
                return function () {
                    i !== c && p++, u.notifyWith(t[e] = this, i[e] = d.call(arguments)), --m || u[(p ? "reject" : "resolve") + "With"](t, i)
                }
            }, a = 0; f > a; a++) (r = c[a]) && e.isFunction(r.promise) ? r.promise().done(l(a, s, c)).fail(l(a, n, o)) : (u.notifyWith(this, r), --m);
            return m || u.resolveWith(s, c), u.promise()
        }
    }, i = function (i, a) {
        var r = this;
        ...
        constructor: i, _cleanup: function () {
            ...
            i.uploadStartTime = t.now(), i.fileManager = {
                ...
                getUploadStats: function (e, a, r) {
                    ...
                    return setTimeout(function () {
                        ...
                        total: r,
                        bps: o.bps,
                        bitrate: i._getSize(o.bps, i.bitRateUnits),
                        pendingBytes: c
            ...
            if (a.enableResumableUpload) {
                ...
                i = a.resumableManager = {
                    init: function (e, t, n) {
                        ...
                        var n, s, l, d, c, u, p, f = i.id;
                        return r.testUrl ? (n = new FormData, s = o.stack[f], a._setUploadData(n, {
                            fileId: f,
                            fileName: s.fileName,
                            fileSize: s.size,
                        ...
                        }, void a._ajaxSubmit(l, d, u, c, n, f, i.fileIndex, r.testUrl)) : void i.uploadResumable()
                        ...
                        var d, c = i.chunkSize, u = i.id, p = i.file, f = i.$thumb, m = t.logMessages, g = i.$btnDelete,
                            h = function (e, t) {
                                t && (e = e.setTokens(t)), e = m.resumableRequestError.setTokens({msg: e}), a._log(e), l.reject(e)
                            };
                        if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
                            if (s > r.maxRetries) return h(m.resumableMaxRetriesReached, {n: r.maxRetries}), void i.setProcessed("error");
                            var v, w, b, _, C, x,
                                y = p.slice ? "slice" : p.mozSlice ? "mozSlice" : p.webkitSlice ? "webkitSlice" : "slice",
                                T = p[y](c * e, c * (e + 1));
                            v = new FormData, d = o.stack[u], a._setUploadData(v, {
                                ...
                                w = a._getOutData(v, r), a.showPreview && (f.hasClass("file-preview-success") || (a._setThumbStatus(f, "Loading"), t.addCss(f, "file-uploading")), g.attr("disabled", !0)), a._raise("filechunkbeforesend", [u, e, s, o, i, w])
                            }, _ = function (t, d, c) {
                                if (a._isAborted()) return void h(m.resumableAborting);
                                w = a._getOutData(v, c, t);
                                var p = a.uploadParamNames, f = p.chunkIndex || "chunkIndex", g = [u, e, s, o, i, w];
                                t.error ? (r.showErrorLog && a._log(n.retryStatus, {
                                    retry: s + 1,
                                    filename: i.fileName,
                                    chunk: e
                                }), a._raise("filechunkerror", g), i.pushAjax(e, s + 1), i.error = t.error, h(t.error)) : (i.logs[t[f]] = !0, i.chunksProcessed[u] || (i.chunksProcessed[u] = {}), i.chunksProcessed[u][t[f]] = !0, i.chunksProcessed[u].data = t, l.resolve.call(null, t), a._raise("filechunksuccess", g), i.check())
                            }, C = function (t, r, n) {
                                return a._isAborted() ? void h(m.resumableAborting) : (w = a._getOutData(v, t), i.setAjaxError(t, r, n), a._raise("filechunkajaxerror", [u, e, s, o, i, w]), i.pushAjax(e, s + 1), void h(m.resumableRetryError, {n: s - 1}))
                            }, x = function () {
            ...
            var i, a, r, n, o, s, l, d, c, u, p, f, m, g, h, v, w, b, _, C, x, y, T, P, k, F, S, E, I, A, D, z, j, $, U,
                M, R, B, O, L, N, Z, H, W = this, q = function (e, i) {
                    return '<object class="kv-preview-data file-preview-' + e + '" title="{caption}" data="{data}" type="' + i + '"' + B + ">\n" + t.DEFAULT_PREVIEW + "\n</object>\n"
                }, V = "btn btn-sm btn-kv " + t.defaultButtonCss();
            i = '{preview}\n<div class="kv-upload-progress kv-hidden"></div><div class="clearfix"></div>\n<div class="file-caption {class}">\n  <div class="input-group {inputGroupClass}">\n      {caption}\n<span class="file-caption-icon"></span>\n' + (t.isBs(5) ? "" : '<div class="input-group-btn input-group-append">\n') + "      {remove}\n      {cancel}\n      {pause}\n      {upload}\n      {browse}\n" + (t.isBs(5) ? "" : "    </div>\n") + "  </div>", a = '{preview}\n<div class="kv-upload-progress kv-hidden"></div>\n<div class="clearfix"></div>\n<span class="{class}">{remove}\n{cancel}\n{upload}\n{browse}\n</span>', r = '<div class="file-preview {class}">\n  {close}  <div class="{dropClass} clearfix">\n    <div class="file-preview-thumbnails clearfix">\n    </div>\n    <div class="file-preview-status text-center text-success"></div>\n    <div class="kv-fileinput-error"></div>\n  </div>\n</div>', o = t.closeButton("fileinput-remove"), n = '<i class="bi-file-earmark-arrow-up"></i>', s = '<input readonly class="file-caption-name form-control {class}">\n',
                ...
                height: "100%",
                "min-height": "480px"
            }, W._isPdfRendered() && (M = W.pdfRendererTemplate.replace("{renderer}", W._encodeURI(W.pdfRendererUrl))), W.defaults = {
                layoutTemplates: {
                    main1: i,
                    main2: a,
                    preview: r,
            ...
            }, e.each(W.defaults, function (t, i) {
                return "allowedPreviewTypes" === t ? void (void 0 === W.allowedPreviewTypes && (W.allowedPreviewTypes = i)) : void (W[t] = e.extend(!0, {}, i, W[t]))
            }), W._initPreviewTemplates()
            ...
            i.previewCache = {
                data: {}, init: function () {
                    ...
                    var r, n, o, s, l, d, c, u = t.INIT_FLAG + e, p = i.previewCache.data, f = p.config[e],
                        m = p.content[e], g = t.ifSet("previewAsData", f, i.initialPreviewAsData),
                    ...
                    var o, s = n.config[e], l = t.ifSet("caption", s), d = t.ifSet("width", s, "auto"),
                        c = t.ifSet("url", s, !1), u = t.ifSet("key", s, null), p = t.ifSet("fileId", s, null),
                        f = i.fileActionSettings, m = i.initialPreviewShowDelete || !1,
                        g = i.initialPreviewDownloadUrl ? i.initialPreviewDownloadUrl + "?key=" + u + (p ? "&fileId=" + p : "") : "",
                        h = s.downloadUrl || g, v = s.filename || s.caption || "", w = !!h,
                        b = t.ifSet("showRemove", s, m), _ = t.ifSet("showDownload", s, t.ifSet("showDownload", f, w)),
                        C = t.ifSet("showZoom", s, t.ifSet("showZoom", f, !0)),
                        x = t.ifSet("showDrag", s, t.ifSet("showDrag", f, !0)), y = c === !1 && a;
                    return _ = _ && s.downloadUrl !== !1 && !!h, o = i._renderFileActions(s, !1, _, b, C, x, y, c, u, !0, h, v), i._getLayoutTemplate("footer").setTokens({
            ...
            t.isPersistentError || t.enableResumableUpload && a || (t.isError = !1, t.$container.removeClass("has-error"), t.$caption.removeClass("is-invalid is-valid file-processing"), i.html(""), e ? i.fadeOut("slow") : i.hide())
            ...
            p && 0 !== s.find(l).length && (a = d.length ? d : c.length ? c : o.$container, r = function () {
            ...
            }, e.extend(!0, i, o.fileActionSettings.dragSettings), o.sortable && o.sortable.destroy(), o.sortable = p.create(s[0], i))
            ...
            a.on(e + ".bs.modal", function (n) {
                if ("bs.modal" === n.namespace) {
                    ...
                    a.data("fileinputPluginId") === i.$element.attr("id") && i._raise("filezoom" + e, r(n)), "shown" === e && (s.removeClass("active").attr("aria-pressed", "false"), o.removeClass("active").attr("aria-pressed", "false"), a.hasClass("file-zoom-fullscreen") && (i._maximizeZoomDialog(), t.checkFullScreen() ? o.addClass("active").attr("aria-pressed", "true") : s.addClass("active").attr("aria-pressed", "true")))
                }
            })
        }, _initZoom: function () {
            ...
            var t, i, a = this, r = a.$modal.data("previewId") || "", n = a.getFrames().toArray(), o = n.length,
                s = a.$modal.find(".btn-kv-prev"), l = a.$modal.find(".btn-kv-next");
            return n.length < 2 ? (s.hide(), void l.hide()) : (s.show(), l.show(), void (o && (t = e(n[0]), i = e(n[o - 1]), s.removeAttr("disabled"), l.removeAttr("disabled"), a.reversePreviewOrder && ([s, l] = [l, s]), t.length && t.attr("id") === r && s.attr("disabled", !0), i.length && i.attr("id") === r && l.attr("disabled", !0))))
            ...
            var r, n, o, s, l, d, c, u, p, f, m, g, h = this, v = i.attr("id"), w = h._getZoom(v), b = h.$modal,
                _ = b.find(".btn-kv-fullscreen"), C = b.find(".btn-kv-borderless"), x = b.find(".btn-kv-toggleheader"),
                y = i.data("zoom");
            y && (y = decodeURIComponent(y), g = w.html().replace(h.zoomPlaceholder, "").setTokens({zoomData: y}), w.html(g), i.data("zoom", ""), w.attr("data-zoom", y)), n = w.attr("data-template") || "generic", r = w.find(".kv-file-content"), o = r.length ? r.html() : "", f = i.data("caption") || h.msgZoomModalHeading, m = i.data("size") || "", u = i.data("description") || "", b.find(".kv-zoom-caption").attr("title", f).html(f), b.find(".kv-zoom-size").html(m), p = b.find(".kv-zoom-description").hide(), u && (h.showDescriptionClose && (u = h._getLayoutTemplate("descriptionClose").setTokens({closeIcon: h.previewZoomButtonIcons.close}) + "</button>" + u), p.show().html(u), h.showDescriptionClose && h._handler(b.find(".kv-desc-hide"), "click", function () {
                ...
                [i, a] = h.rtl ? [39, 37] : [37, 39], e.each({prev: [o, i], next: [s, a]}, function (e, t) {
                    ...
                    r === a && i.length && (b.focus(), i.attr("disabled") || (i.blur(), setTimeout(function () {
                        i.focus(), h._zoomSlideShow(e, l), setTimeout(function () {
            ...
            e && e.length && (t.initModal(a), t.setHtml(a, i._getModalContent()), i._setZoomContent(e), a.data({
                backdrop: !1,
                fileinputPluginId: i.$element.attr("id")
            }), a.find(".kv-zoom-body").css("height", i.zoomModalHeight), a.modal("show"), i._initZoomButtons())
            ...
            var a, r, n, o, s = this, l = s.$modal.find(".kv-zoom-actions .btn-kv-" + t), d = s.getFrames().toArray(),
                c = [], u = d.length;
            if (s.reversePreviewOrder && (t = "prev" === t ? "next" : "prev"), !l.attr("disabled")) {
                ...
                0 > o || o >= u || !c[o] || (a = e(c[o]), a.length && s._setZoomContent(a, t), s._initZoomButtons(), s._raise("filezoom" + t, {
                    previewId: i,
                    modal: s.$modal
                }))
            }
            ...
            var t, i = this;
            (i._inputFileCount() || i.isAjaxUpload) && i.showPreview && i.isPreviewable && (i.isAjaxUpload && i.fileManager.count() > 0 ? (t = e.extend(!0, {}, i.getFileList()), i.fileManager.clear(), i._clearFileInput()) : t = i.$element[0].files, t && t.length && (i.readFiles(t), i._setFileDropZoneTitle()))
            ...
            var d, c, u, p = this, f = p.taskManager;
            p._raise("filepreajax", [n, o, s]) && (n.append("initialPreview", JSON.stringify(p.initialPreview)), n.append("initialPreviewConfig", JSON.stringify(p.initialPreviewConfig)), n.append("initialPreviewThumbTags", JSON.stringify(p.initialPreviewThumbTags)), p._initAjaxSettings(), p._mergeAjaxCallback("beforeSend", t), p._mergeAjaxCallback("success", i), p._mergeAjaxCallback("complete", a), p._mergeAjaxCallback("error", r), l = l || p.uploadUrlThumb || p.uploadUrl, "function" == typeof l && (l = l()), u = p._getExtraData(o, s) || {}, "object" == typeof u && e.each(u, function (e, t) {
                n.append(e, t)
            }), c = {
                xhr: function () {
                    var t = e.ajaxSettings.xhr();
                    return p._initXhr(t, o)
                },
                url: p._encodeURI(l),
                type: "POST",
                dataType: "json",
                ...
                processData: !1,
                contentType: !1
            }, d = e.extend(!0, {}, c, p._ajaxSettings), p.ajaxQueue.push(d), f.addTask(o + "-" + s, function () {
                var t, i, a = this.self;
                t = a.ajaxQueue.shift(), i = e.ajax(t), a.ajaxRequests.push(i)
            }).runWithContext({self: p}))
        }, _mergeArray: function (e, i) {
            var a = this, r = t.cleanArray(a[e]), n = t.cleanArray(i);
            a[e] = r.concat(n)
        }, _initUploadSuccess: function (i, a, r) {
            var n, o, s, l, d, c, u, p, f, m = this;
            return !m.showPreview || "object" != typeof i || e.isEmptyObject(i) ? void m._resetCaption() : (void 0 !== i.initialPreview && i.initialPreview.length > 0 && (m.hasInitData = !0, d = i.initialPreview || [], c = i.initialPreviewConfig || [], u = i.initialPreviewThumbTags || [], n = void 0 === i.append || i.append, d.length > 0 && !t.isArray(d) && (d = d.split(m.initialPreviewDelimiter)), d.length && (m._mergeArray("initialPreview", d), m._mergeArray("initialPreviewConfig", c), m._mergeArray("initialPreviewThumbTags", u)), void 0 !== a ? r ? (p = a.attr("id"), f = m._getUploadCacheIndex(p), null !== f && (m.uploadCache[f] = {
                id: p,
                content: d[0],
                config: c[0] || [],
                tags: u[0] || [],
                append: n
            })) : (s = m.previewCache.add(d[0], c[0], u[0], n), o = m.previewCache.get(s, !1), l = t.createElement(o).hide().appendTo(a), a.fadeOut("slow", function () {
                var e = l.find("> .file-preview-frame");
                e && e.length && e.insertBefore(a).fadeIn("slow").css("display:inline-block"), m._initPreviewActions(), m._clearFileInput(), a.remove(), l.remove(), m._initSortable()
            })) : (m.previewCache.set(d, c, u, n), m._initPreview(), m._initPreviewActions())), void m._resetCaption())
            ...
            var o, s, l, d, c, u, p, f, m, g, h, v, w, b = this, _ = b.fileManager, C = _.count(), x = new FormData,
                ...
                S = b.fileManager.getFileName(a, !0), E = function () {
                    n && n.resolve && n.resolve()
                }, I = function () {
                    n && n.reject && n.reject()
                };
            b.enableResumableUpload || (b.showPreview && (s = _.getThumb(a), p = s.find(".file-thumb-progress"), d = s.find(".kv-file-upload"), c = s.find(".kv-file-remove"), p.show()), 0 === C || !T || b.showPreview && d && d.hasClass("disabled") || b._abort(F) || (w = function () {
                ...
                b.fileBatchCompleted && setTimeout(function () {
                    ...
                    b._updateInitialPreview(), b.unlock(i), i && b._clearFileInput(), e = b.$preview.find(".file-preview-initial"), b.uploadAsync && e.length && (t.addCss(e, t.SORT_CSS), b._initSortable()), b._raise("filebatchuploadcomplete", [_.stack, b._getExtraData()]), b.retryErrorUploads && 0 !== a || _.clear(), b._setProgress(101), b.ajaxAborted = !1
                }, b.processDelay)
            }, f = function (n) {
                ...
                var f = b.showPreview && s.attr("id") ? s.attr("id") : y;
                o = b._getOutData(x, c, n), e.extend(!0, F, o), setTimeout(function () {
                    t.isEmpty(n) || t.isEmpty(n.error) ? (b.showPreview && (b._setThumbStatus(s, "Success"), d.hide(), b._initUploadSuccess(n, s, r), b._setProgress(101, p)), b._raise("fileuploaded", [o, f, i, b._getThumbFileId(s)]), r ? (w(), E()) : b.fileManager.remove(s)) : (u = !0, m = b._parseError(P, c, b.msgUploadError, b.fileManager.getFileName(a)), b._showFileError(m, F), b._setPreviewError(s, !0), b.retryErrorUploads || d.hide(), r && (w(), E()), b._setProgress(101, b._getFrame(f).find(".file-thumb-progress"), b.msgUploadError))
                }, b.processDelay)
            }, h = function () {
                ...
                m = b._parseError(P, t, n, b.fileManager.getFileName(a)), u = !0, setTimeout(function () {
                    var i;
                    r && (w(), I()), b.fileManager.setProgress(a, 100), b._setPreviewError(s, !0), b.retryErrorUploads || d.hide(), e.extend(!0, F, b._getOutData(x, t)), b._setProgress(101, b.$progress, b.msgAjaxProgressError.replace("{operation}", P)), i = b.showPreview && s ? s.find(".file-thumb-progress") : "", b._setProgress(101, i, b.msgUploadError), b._showFileError(m, F)
                }, b.processDelay)
            }, b._setFileData(x, k.file, S, a), b._setUploadData(x, {fileId: a}), b._ajaxSubmit(f, g, h, v, x, a, i)))
            ...
            var i, a, r, n, o, s, l = this, d = l.fileManager, c = d.total(), u = {},
                p = c > 0 || !e.isEmptyObject(l.uploadExtraData), f = new FormData, m = l.ajaxOperations.uploadBatch;
            if (0 !== c && p && !l._abort(u)) {
                s = function () {
                    ...
                    var n = l._getOutData(f, r, i), d = 0, c = l._getThumbs(":not(.file-preview-success)"),
                    ...
                    }), l._initUploadSuccess(i)), o = l._parseError(m, r, l.msgUploadError), l._showFileError(o, n, "filebatchuploaderror"), l._setProgress(101, l.$progress, l.msgUploadError))
                }, n = function () {
                    ...
                    o = l._parseError(m, t, a), l._showFileError(o, r, "filebatchuploaderror"), l.uploadFileCount = c - 1, l.showPreview && (l._getThumbs().each(function () {
                        var t = e(this);
                        t.removeClass("file-uploading"), l._getThumbFile(t) && l._setPreviewError(t)
                    }), l._getThumbs().removeClass("file-uploading"), l._getThumbs(" .kv-file-upload").removeAttr("disabled"), l._getThumbs(" .kv-file-delete").removeAttr("disabled"), l._setProgress(101, l.$progress, l.msgAjaxProgressError.replace("{operation}", m)))
                };
                var g = 0;
                e.each(l.fileManager.stack, function (e, i) {
                    t.isEmpty(i.file) || l._setFileData(f, i.file, i.nameFmt || "untitled_" + g, e), g++
            ...
            i._initZoomButton(), a.find(n).each(function () {
                var a, n, o, c, u = e(this), p = u.data("url") || i.deleteUrl, f = u.data("key"),
                    m = i.ajaxOperations.deleteThumb;
                if (!t.isEmpty(p) && void 0 !== f) {
                    "function" == typeof p && (p = p());
                    var g, h, v, w, b, _ = u.closest(t.FRAMES), C = i.previewCache.data, x = _.attr("data-fileindex");
                    x = parseInt(x.replace(t.INIT_FLAG, "")), v = t.isEmpty(C.config) && t.isEmpty(C.config[x]) ? null : C.config[x], b = t.isEmpty(v) || t.isEmpty(v.extra) ? r : v.extra, w = v && (v.filename || v.caption) || "", "function" == typeof b && (b = b()), h = {
                        ...
                        i.ajaxAborted = !1, i._raise("filepredelete", [f, e, b]), i._abort() ? e.abort() : (u.removeClass(l), t.addCss(_, "file-uploading"), t.addCss(u, "disabled " + s))
                    }, o = function (e, r, n) {
                        var o, c;
                        return t.isEmpty(e) || t.isEmpty(e.error) ? (_.removeClass("file-uploading").addClass("file-deleted"), void _.fadeOut("slow", function () {
                            x = parseInt(_.attr("data-fileindex").replace(t.INIT_FLAG, "")), i.previewCache.unset(x), i._deleteFileIndex(_), o = i.previewCache.count(!0), c = o > 0 ? i._getMsgSelected(o) : "", i._setCaption(c), i._raise("filedeleted", [f, n, b]), i._clearObjects(_), _.remove(), d()
                        })) : (h.jqXHR = n, h.response = e, a = i._parseError(m, n, i.msgDeleteError, w), i._showFileError(a, h, "filedeleteerror"), _.removeClass("file-uploading"), u.removeClass("disabled " + s).addClass(l), void d())
                    }, c = function (e, t, a) {
                        var r = i._parseError(m, e, a, w);
            ...
            var a, r, n = this, o = parseFloat(t), s = n.fileSizeGetter;
            return e.isNumeric(t) && e.isNumeric(o) ? ("function" == typeof s ? r = s(o) : 0 === o ? r = "0.00 B" : (i || (i = n.sizeUnits), a = Math.floor(Math.log(o) / Math.log(n.bytesToKB)), r = (o / Math.pow(n.bytesToKB, a)).toFixed(2) + " " + i[a]), n._getLayoutTemplate("size").replace("{sizeText}", r)) : ""
        }, _getFileType: function (e) {
            var t = this;
            return t.mimeTypeAliases[e] || e
        }, _generatePreviewTemplate: function (i, a, r, n, o, s, l, d, c, u, p, f, m, g) {
            var h, v, w, b = this, _ = b.slug(r), C = "", x = "",
                y = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth, T = _,
                P = _, k = "type-default", F = u || b._renderFileFooter(i, _, d, "auto", l), S = b.preferIconicPreview,
                E = b.preferIconicZoomPreview, I = S ? "other" : i;
            return v = 400 > y ? b.previewSettingsSmall[I] || b.defaults.previewSettingsSmall[I] : b.previewSettings[I] || b.defaults.previewSettings[I], v && e.each(v, function (e, t) {
                x += e + ":" + t + ";"
            }), w = function (a, l, d, u, g) {
                var h, v = d ? "zoom-" + o : o, w = b._getPreviewTemplate(a), C = (c || "") + " " + u;
                return b.frameClass && (C = b.frameClass + " " + C), d && (C = C.replace(" " + t.SORT_CSS, "")), w = b._parseFilePreviewIcon(w, r), "object" !== i || n || e.each(b.defaults.fileTypeSettings, function (e, t) {
                    "object" !== e && "other" !== e && t(r, n) && (k = "type-" + e)
                }), t.isEmpty(m) || (void 0 !== m.title && null !== m.title && (T = m.title), void 0 !== m.alt && null !== m.alt && (T = m.alt)), h = {
                    previewId: v,
                    caption: _,
                    title: T,
                    alt: P,
                    ...
                    typeCss: k,
                    footer: F,
                    data: d && g ? b.zoomPlaceholder + "{zoomData}" : l,
                    template: f || i,
                    style: x ? 'style="' + x + '"' : "",
                    zoomData: g ? encodeURIComponent(g) : ""
                }, d && (h.zoomCache = "", h.zoomData = "{zoomData}"), w.setTokens(h)
            }, p = p || o.slice(o.lastIndexOf("-") + 1), b.fileActionSettings.showZoom && (C = w(E ? "other" : i, a, !0, "kv-zoom-thumb", g)), C = "\n" + b._getLayoutTemplate("zoomCache").replace("{zoomContent}", C), "function" == typeof b.sanitizeZoomCache && (C = b.sanitizeZoomCache(C)), h = w(S ? "other" : i, a, !1, "kv-preview-thumb", g), h.setTokens({zoomCache: C})
            ...
            if (a.showPreview) {
                var n, o = t.getFileName(e), s = e ? e.type : "", l = e.size || 0, d = a._getFileName(e, ""),
                    ...
                    f = a._getThumbId(p);
                a._clearDefaultPreview(), n = a._generatePreviewTemplate("other", u, o, s, f, p, c, l), a._addToPreview(r, n), a._setThumbAttr(f, d, l), i === !0 && a.isAjaxUpload && a._setThumbStatus(a._getFrame(f), "Error")
            }
        }, _previewFile: function (e, i, a, r, n) {
            if (this.showPreview) {
                var o, s = this, l = t.getFileName(i), d = n.type, c = n.name, u = s._parseFileType(d, l),
                    p = s.$preview, f = i.size || 0, m = "image" === u ? a.target.result : r, g = s.fileManager,
                    h = g.getId(i), v = s._getThumbId(h);
                o = s._generatePreviewTemplate(u, m, l, d, v, h, !1, f), s._clearDefaultPreview(), s._addToPreview(p, o);
                var w = s._getFrame(v);
                s._validateImageOrientation(w.find("img"), i, v, h, c, d, f, m), s._setThumbAttr(v, c, f), s._initSortable()
            }
            ...
            if (n.showPreview || o && o.length) {
                var s, l = n.fileManager, d = n.resumableManager, c = l.getThumb(i), u = 0, p = l.getTotalSize(),
                    f = e.extend(!0, {}, r);
                if (n.enableResumableUpload) {
                    var m, g = r.loaded, h = d.getUploadedSize(), v = d.file.size;
                    g += h, m = l.uploadedSize + g, a = t.round(100 * g / v), r.pendingBytes = v - h, n._setResumableProgress(a, r, c), s = Math.floor(100 * m / p), f.pendingBytes = p - m, n._setResumableProgress(s, f)
                    ...
                    u += t.loaded
                }), f.pendingBytes = p - u, s = t.round(u / p * 100), n._setProgress(s, null, null, n._getStats(f))
            }
            ...
            var l, d, c, u, p = this, f = "Small" === i ? "min" : "max", m = p[f + "Image" + o];
            !t.isEmpty(m) && a.length && (c = a[0], d = "Width" === o ? c.naturalWidth || c.width : c.naturalHeight || c.height, u = "Small" === i ? d >= m : m >= d, u || (l = p["msgImage" + o + i].setTokens({
                name: n,
                size: m
            }), p._showFileError(l, s), p._setPreviewError(r)))
            ...
            var o, s, l, d = this, c = !i || !i.length, u = !a || !a.length, p = !1,
                f = c && n && "image" === n.attr("data-template");
            c && u || (l = "load.fileinputimageorient", f ? (i = a, a = null, i.css(d.previewSettings.image), s = e(document.createElement("div")).appendTo(n.find(".kv-file-content")), o = e(document.createElement("span")).insertBefore(i), i.css("visibility", "hidden").removeClass("file-zoom-detail").appendTo(s)) : p = !i.is(":visible"), i.off(l).on(l, function () {
                ...
                var e = i[0], l = a && a.length ? a[0] : null, c = e.offsetHeight, u = e.offsetWidth,
                    m = t.getRotation(r);
                if (p && (n.find(".kv-file-content").css("visibility", "visible"), d.$preview.addClass("hide-content")), i.data("orientation", r), l && a.data("orientation", r), 5 > r) return t.setTransform(e, m), void t.setTransform(l, m);
                var g = Math.atan(u / c), h = Math.sqrt(Math.pow(c, 2) + Math.pow(u, 2)),
                    v = h ? c / Math.cos(Math.PI / 2 + g) / h : 1, w = " scale(" + Math.abs(v) + ")";
                t.setTransform(e, m + w), t.setTransform(l, m + w), f && (i.css("visibility", "visible").insertAfter(o).addClass("file-zoom-detail"), o.remove(), s.remove())
            }))
        }, _validateImageOrientation: function (i, a, r, n, o, s, l, d) {
            var c, u, p = this, f = null, m = p.autoOrientImage;
            return f = p._getExifObj(d), p.canOrientImage ? (i.css("image-orientation", m ? "from-image" : "none"), void p._validateImage(r, n, o, s, l, d, f)) : (u = t.getZoomSelector(r, " img"), (c = f ? f["0th"][piexif.ImageIFD.Orientation] : null) ? (p.setImageOrientation(i, e(u), c, p._getFrame(r)), p._raise("fileimageoriented", {
                $img: i,
                file: a
            }), void p._validateImage(r, n, o, s, l, d, f)) : void p._validateImage(r, n, o, s, l, d, f))
        }, _validateImage: function (e, t, i, a, r, n, o) {
            var s, l, d, c = this, u = c.$preview, p = c._getFrame(e), f = p.attr("data-fileindex"), m = p.find("img");
            i = i || "Untitled", m.one("load", function () {
                l = p.width(), d = u.width(), l > d && m.css("width", "100%"), s = {
                    ind: f,
                    id: e,
                    fileId: t
                }, c._checkDimensions(f, "Small", m, p, i, "Width", s), c._checkDimensions(f, "Small", m, p, i, "Height", s), c.resizeImage || (c._checkDimensions(f, "Large", m, p, i, "Width", s), c._checkDimensions(f, "Large", m, p, i, "Height", s)), c._raise("fileimageloaded", [e]), c.fileManager.addImage(t, {
                    ind: f,
                    img: m,
                    thumb: p,
                    pid: e,
                    ...
                    imgData: n,
                    exifObj: o
                }), p.data("exif", o), c._validateAllImages()
            }).one("error", function () {
            ...
            var o, s, l, d, c, u, p, f, m, g, h = this, v = e(a.img)[0], w = v.naturalWidth, b = v.naturalHeight, _ = 1,
                C = h.maxImageWidth || w, x = h.maxImageHeight || b, y = !(!w || !b), T = h.imageCanvas,
                P = h.imageCanvasContext, k = a.typ, F = a.pid, S = a.ind, E = a.thumb, I = a.exifObj;
            if (c = function (e, t, i) {
                h.isAjaxUpload ? h._showFileError(e, t, i) : h._showError(e, t, i), h._setPreviewError(E)
            }, f = h.fileManager.getFile(i), m = {
                id: F,
                index: S,
                fileId: i
            }, g = [i, F, S], (!f || !y || C >= w && x >= b) && (y && f && h._raise("fileimageresized", g), r.val++,
            r.val === n && h._raise("fileimagesresized"), !y)) return void c(h.msgImageResizeError, m, "fileimageresizeerror");
            ...
            try {
                P.drawImage(v, 0, 0, w, b), d = T.toDataURL(k, h.resizeQuality), I && (p = window.piexif.dump(I), d = window.piexif.insert(p, d)), o = t.dataURI2Blob(d), h.fileManager.setFile(i, o), h._raise("fileimageresized", g), r.val++, r.val === n && h._raise("fileimagesresized", [void 0, void 0]), o instanceof Blob || c(h.msgImageResizeError, m, "fileimageresizeerror")
            } catch (A) {
                r.val++, r.val === n && h._raise("fileimagesresized", [void 0, void 0]), u = h.msgImageResizeException.replace("{errors}", A.message), c(u, m, "fileimageresizeexception")
            }
            ...
            var o, s, l = this, d = l.fileActionSettings, c = d.showRemove, u = d.showDrag, p = d.showUpload,
                f = d.showZoom, m = l._getLayoutTemplate("footer"), g = l._getLayoutTemplate("indicator"),
                h = n ? d.indicatorError : d.indicatorNew, v = n ? d.indicatorErrorTitle : d.indicatorNewTitle,
                w = g.setTokens({indicator: h, indicatorTitle: v});
            return a = l._getSize(a), s = {
                ...
                progress: "",
                indicator: w
            }, l.isAjaxUpload ? (s.progress = l._renderThumbProgress(), s.actions = l._renderFileActions(s, p, !1, c, f, u, !1, !1, !1)) : s.actions = l._renderFileActions(s, !1, !1, !1, f, u, !1, !1, !1), o = m.setTokens(s), o = t.replaceTags(o, l.previewThumbTags)
            ...
            var f, m = s === !1 ? "" : ' data-url="' + s + '"', g = "", h = "",
                v = l === !1 ? "" : ' data-key="' + l + '"', w = "", b = "", _ = "",
                C = p._getLayoutTemplate("actions"), x = p.fileActionSettings,
                y = p.otherActionButtons.setTokens({dataKey: v, key: l}),
            ...
            })), n && d && (f = "drag-handle-init " + x.dragClass, h = p._getLayoutTemplate("actionDrag").setTokens({
                dragClass: f,
                dragTitle: x.dragTitle,
                dragIcon: x.dragIcon
            })), C.setTokens({"delete": w, upload: b, download: _, zoom: g, drag: h, other: y})
        }, _browse: function (e) {
            var t = this;
            ...
            if (e(document.body).off("focusin.fileinput focusout.fileinput"), !a.changeTriggered) {
                ...
                var r, n, o, s, l = a.$element, d = arguments.length > 1, c = a.isAjaxUpload,
                    u = d ? arguments[1] : l[0].files, p = a.fileManager.count(), f = t.isEmpty(l.attr("multiple")),
                    m = !c && f ? 1 : a.maxFileCount, g = a.maxTotalFileCount, h = g > 0 && g > m, v = f && p > 0,
                    w = function (t, i, r, n) {
                        var o = e.extend(!0, {}, a._getOutData(null, {}, {}, u), {id: r, index: n}),
                            s = {id: r, index: n, file: i, files: u};
                        return a.isPersistentError = !0, a._setLoading("hide"), c ? a._showFileError(t, o) : a._showError(t, s)
                    }, b = function (e, t, i) {
                ...
                if (a._resetErrors(), s = r.length, o = c ? a.fileManager.count() + s : s, n = a._getFileCount(o, h ? !1 : void 0), m > 0 && n > m) {
                    if (!a.autoReplace || s > m) return void b(a.autoReplace && s > m ? s : n, m);
                    n > m && a._resetPreviewThumbs(c)
                } else {
                    if (h && (n = a._getFileCount(o, !0), g > 0 && n > g)) {
                        if (!a.autoReplace || s > m) return void b(a.autoReplace && s > g ? s : n, g, !0);
                        n > m && a._resetPreviewThumbs(c)
                    }
            ...
            var a, r, n, o, s = e.name || "", l = e.type || "", d = (e.size || 0) / i.bytesToKB,
                c = i._parseFileType(l, s), u = i.allowedPreviewTypes, p = i.allowedPreviewMimeTypes,
                f = i.allowedPreviewExtensions || [], m = i.disabledPreviewTypes, g = i.disabledPreviewMimeTypes,
            ...
            return a = !u || -1 !== u.indexOf(c), r = !p || -1 !== p.indexOf(l), n = !f.length || t.compare(s, w), o = m && -1 !== m.indexOf(c) || g && -1 !== g.indexOf(l) || h.length && t.compare(s, b) || v && !isNaN(v) && d > v, !o && (a || r || n)
            ...
            var a, r = this, n = r.reader, o = r.$previewContainer, s = r.$previewStatus, l = r.msgLoading,
                ...
                m = f ? f.length : 0, g = r.allowedFileExtensions, h = t.isEmpty(g) ? "" : g.join(", "),
                v = function (t, n, o, s, l) {
                    var d, c = e.extend(!0, {}, r._getOutData(null, {}, {}, i), {id: o, index: s, fileId: l}),
                        p = {id: o, index: s, fileId: l, file: n, files: i};
                    r._previewDefault(n, !0), d = r._getFrame(o, !0), r._setLoading("hide"), r.isAjaxUpload ? setTimeout(function () {
                        a(s + 1)
            ...
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                ...
                r.lock(!0);
                var x, y, T, P, k, F, S, E, I, A, D, z, j = i[w], $ = r._getFileId(j), U = c + "-" + $, M = p.image,
                    R = r._getFileName(j, ""), B = (j && j.size || 0) / r.bytesToKB, O = "", L = t.createObjectURL(j),
                    N = 0, Z = "", H = !1, W = 0, q = function () {
                        var e = !!C.loadedImages[$], t = d.setTokens({index: w + 1, files: u, percent: 50, name: R});
                        setTimeout(function () {
                            s.html(t), r._updateFileDetails(u), a(w + 1)
                        }, r.processDelay), r._raise("fileloaded", [j, U, $, w, n]) && r.isAjaxUpload ? e || C.add(j) : e && C.removeFile($)
                    };
                if (j) {
                    if (E = C.getId(j), m > 0) for (y = 0; m > y; y++) F = f[y], S = r.msgFileTypes[F] || F, Z += 0 === y ? S : ", " + S;
                    if (R === !1) return void a(w + 1);
                    if (0 === R.length) return T = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName(j), "[unknown]")), void v(T, j, U, w, E);
                    if (t.isEmpty(g) || (O = new RegExp("\\.(" + g.join("|") + ")$", "i")), x = B.toFixed(2), r.isAjaxUpload && C.exists(E) || r._getFrame(U, !0).length) {
                        var V = {id: U, index: w, fileId: E, file: j, files: i};
                        return T = r.msgDuplicateFile.setTokens({
                            name: R,
                            size: x
                        }), void (r.isAjaxUpload ? (r.duplicateErrors.push(T), r.isDuplicateError = !0, r._raise("fileduplicateerror", [j, E, R, x, U, w]), a(w + 1), r._updateFileDetails(u)) : (r._showError(T, V), r.unlock(), u = 0, r._clearFileInput(), r.reset(), r._updateFileDetails(u)))
                    }
                    if (r.maxFileSize > 0 && B > r.maxFileSize) return T = r.msgSizeTooLarge.setTokens({
                        name: R,
                        size: x,
                        maxSize: r.maxFileSize
                    }), void v(T, j, U, w, E);
                    if (null !== r.minFileSize && B <= t.getNum(r.minFileSize)) return T = r.msgSizeTooSmall.setTokens({
                        name: R,
                        size: x,
                        minSize: r.minFileSize
                    }), void v(T, j, U, w, E);
                    if (!t.isEmpty(f) && t.isArray(f)) {
                        for (y = 0; y < f.length; y += 1) P = f[y], A = p[P], N += A && "function" == typeof A && A(j.type, t.getFileName(j)) ? 1 : 0;
                        if (0 === N) return T = r.msgInvalidFileType.setTokens({
                            name: R,
                            types: Z
                        }), void v(T, j, U, w, E)
                    }
                    if (0 === N && !t.isEmpty(g) && t.isArray(g) && !t.isEmpty(O) && (k = t.compare(R, O), N += t.isEmpty(k) ? 0 : k.length, 0 === N)) return T = r.msgInvalidFileExtension.setTokens({
                        name: R,
                        extensions: h
                    }), void v(T, j, U, w, E);
                    if (!r._canPreview(j)) return I = r.isAjaxUpload && r._raise("filebeforeload", [j, w, n]), r.isAjaxUpload && I && C.add(j), r.showPreview && I && (o.addClass("file-thumb-loading"), r._initCapStatus("processing"), r._previewDefault(j), r._initFileActions()), void setTimeout(function () {
                        I && r._updateFileDetails(u), a(w + 1), r._raise("fileloaded", [j, U, $, w])
                    }, 10);
                    D = M(j.type, R), s.html(l.replace("{index}", w + 1).replace("{files}", u)), o.addClass("file-thumb-loading"), r._initCapStatus("processing"), n.onerror = function (e) {
                        r._errorHandler(e, R)
                    }, n.onload = function (i) {
                        var a, l, d, c, u, f, m = [], g = function () {
                            var e = new FileReader;
                            e.onerror = function (e) {
                                r._errorHandler(e, R)
                            }, e.onload = function (e) {
                                return r.isAjaxUpload && !r._raise("filebeforeload", [j, w, n]) ? (H = !0, r._resetCaption(), n.abort(), s.html(""), o.removeClass("file-thumb-loading"), r._initCapStatus("valid"), void r.enable()) : (r._previewFile(w, j, e, L, l), r._initFileActions(), void q())
                            }, e.readAsDataURL(j)
                        };
                        if (l = {name: R, type: j.type}, e.each(p, function (e, t) {
                            ...
                            if (a = m.join("").toLowerCase().substring(0, 8), f = t.getMimeType(a, "", ""), t.isEmpty(f) && (u = t.arrayBuffer2String(n.result), f = t.isSvg(u) ? "image/svg+xml" : t.getMimeType(a, u, j.type)), l = {
                                name: R,
                                type: f
                            }, D = M(f, "")) return void g(z)
                        }
                        return r.isAjaxUpload && !r._raise("filebeforeload", [j, w, n]) ? (H = !0, r._resetCaption(), n.abort(), s.html(""), o.removeClass("file-thumb-loading"), r._initCapStatus("valid"), void r.enable()) : (r._previewFile(w, j, i, L, l), r._initFileActions(), void q())
            ...
            if (n.bpsLog = [], n.bps = 0, r.isAjaxUpload && !r.isDisabled && r._isFileSelectionValid(o)) {
                ...
                if (r.cancelling = !1, r._showProgress(), r.lock(), 0 === o && l) return r._setProgress(2), void r._uploadExtraOnly();
        ...
        if (t.hasFileAPISupport() || t.isIE(9)) {
            ...
            switch (r.shift(), this.each(function () {
                var o, s = e(this), l = s.data("fileinput"), d = "object" == typeof a && a,
                    c = d.theme || s.data("theme"), u = {}, p = {},
                    f = d.language || s.data("language") || e.fn.fileinput.defaults.language || "en";
                l || (c && (p = e.fn.fileinputThemes[c] || {}), "en" === f || t.isEmpty(e.fn.fileinputLocales[f]) || (u = e.fn.fileinputLocales[f] || {}), o = e.extend(!0, {}, e.fn.fileinput.defaults, p, e.fn.fileinputLocales.en, u, d, s.data()), l = new i(this, o), s.data("fileinput", l)), "string" == typeof a && n.push(l[a].apply(l, r))
            }), n.length) {
                case 0:
                    return this;
                case 1:
